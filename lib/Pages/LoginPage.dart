  ...
  void verifyPhoneNumber() async {
    PhoneVerificationCompleted verificationCompleted =
      ...
      if (user != null) {
        ...
        preferences.setString("api_token", UserDetails.apiToken);

        Navigator.of(context).pushReplacement(MaterialPageRoute(
          builder: (context) =>
              HomeNavigationBarWidget(id: UserDetails.id, index: 0),
        ));
      } else {
                              ...
                              child: InkWell(
                                onTap: () {
                                  ...
                                  AlertDialog alert = AlertDialog(
                                    title: Text("Reset Password", style:Theme.of(context).textTheme.headline6.apply(fontSizeFactor: 0.7,  color:Colors.black), textAlign: TextAlign.center,  ),
                                    content: Container(
                              ...
                              child: InkWell(
                                  onTap: () {
                                    ...
                                    if (_phoneNumberController.text.isEmpty ||
                                      ...
                                      FirebaseMessaging.instance.getToken().then((rememberToken) {
LoginController.login(
                                              (country_code +
                                                  _phoneNumberController.text),
                                              passwordController.text.trim(), rememberToken)
                                          .then((value) async {
                                        if (value != null &&
                                            value.statusCode == 200) {
                                          if (UserDetails.isOtpVerificationOn) {
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.of(context)
                                    ...
                                    builder: (context) => RegisterPhoneWidget(),
                                  ));
                                },
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.center,
