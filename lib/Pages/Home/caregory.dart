...
class Category extends StatefulWidget {
  List<CategoryClass> lstMessages;
  Category({@required this.lstMessages});
  @override
...
class _CategoryState extends State<Category> {
  ...
  Widget _product(List<CategoryClass> item) {
    List<Widget> lstW = [];
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image:
                          NetworkImage('https://wallet.jainalufoils.com/' +
                              '${item[i].icon}'), fit: BoxFit.fill,
                        ),
                        boxShadow: [
                          BoxShadow(
                              color: Colors.black
