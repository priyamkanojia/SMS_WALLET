...
class RegisterPhoneWidget extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return RegisterPhoneWidgetState();
  }
}

class RegisterPhoneWidgetState extends State<RegisterPhoneWidget> {
  bool _saving = false;
  void submit() {
    setState(() {
      _saving = true;
      ...
      if (user != null) {
        ...
        _auth.signOut();
          ...
          Navigator.of(context).pushReplacement(MaterialPageRoute(
            builder: (context) => RegisterWidget(phone: country_code+_phoneNumberController.text,),
          ));
                          ...
                          Text("Welcome",
                              ...
                              style:
                                  Theme.of(context).textTheme.headline6.apply(
                                      ...
                                      color: Colors.white)),
                          SizedBox(height: 8),
                          _verificationId ==null ?Text("Sign Up",
                              textAlign: TextAlign.center,
                              style: Theme.of(context)
                                  ...
                                  .apply(
                                      fontSizeFactor: 1.1,
                                      fontWeightDelta: 30,
                                      color: Colors.white)):Text("OTP Verification",
                              textAlign: TextAlign.center,
                              style: Theme.of(context)
                                  .textTheme
                                  .headline6
...
Text("Login",
                      ...
                      : Column(
                          children: [
                            // SizedBox(height: 20),
                            SpinKitThreeBounce(color: MyColors.lightBlue,size: 32,),
                            SizedBox(height: 40),
                            Container(
                              width: MediaQuery.of(context).size.width,
                              child: Text(
                                  "Enter 6 Digit OTP Sent To\n" + country_code+_phoneNumberController.text,
                                  textAlign: TextAlign.center,
                                  style: Theme.of(context)
                                      .textTheme
                                      .headline6
                            ...
                            Container(
                              ...
                              child: InkWell(
                                  onTap: () {
                                    if(_smsController.text.isNotEmpty && _smsController.text.length==6){
 setState(() {
                                      _saving = true;
                                    });
